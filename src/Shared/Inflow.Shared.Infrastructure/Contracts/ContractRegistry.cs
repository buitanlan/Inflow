...
internal class ContractRegistry(IModuleRegistry moduleRegistry, ILogger<ContractRegistry> logger) : IContractRegistry
{
    ...
    private class ContractException(string message) : Exception(message);
}
